...
import { ArrowLeft, Layers, Lock, Unlock, Brain, BookOpen, Map, PenTool, ScrollText, Lightbulb, Cards, TestTube, GraduationCap, CheckSquare, BarChart3 } from 'lucide-react';
            ...
            <aside className="space-y-4">
              <div className="border-2 border-ink-600 bg-ink-800 p-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2 font-terminal text-base text-slate2-300">
                    <Cards className="mt-0.5 h-4 w-4 shrink-0 text-gold-300" />
