...
export const courses: Course[] = [
  ...
  },
  {
    ...
    category: 'UNAJ - CICLO INICIAL',
    description:
      'Analiza la cultura como construcción social, desnaturalizando prácticas cotidianas y comprendiendo los mecanismos de poder, sentido común e identidad.',
    hours: 20,
    status: 'unlocked',
    icon: Landmark,
    accent: 'gold',
    era: '1er Cuatrimestre 2026',
    lessons: 12,
    isModuleGroup: true,
  },
  {
