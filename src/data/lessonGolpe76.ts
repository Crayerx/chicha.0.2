...
export const quizQuestionsGolpe76: QuizQuestion[] = [
  ...
  },
  {
    id: 7,
    type: 'multiple',
    question: '¿A qué presidenta derrocó el golpe de Estado del 24 de marzo de 1976?',
    options: [
    ...
    correctIndex: 0,
    explanation: 'La Junta Militar derrocó a María Estela "Isabel" Martínez de Perón, quien gobernaba desde la muerte de Juan Domingo Perón en 1974.',
    accent: 'gold',
  },
  {
    id: 8,
    type: 'truefalse',
    question: 'La Triple A (Alianza Anticomunista Argentina) ya actuaba de forma clandestina antes del golpe, durante el gobierno de Isabel Perón.',
    options: ['Verdadero', 'Falso'],
    correctIndex: 0,
    explanation: 'Verdadero. La Triple A operó desde el propio Estado entre 1973 y 1976, persiguiendo y asesinando opositores antes del golpe militar.',
    accent: 'ember',
  },
  {
    id: 9,
    type: 'multiple',
    question: '¿Qué ocurrió con los partidos políticos tras el golpe de 1976?',
    options: [
      'Se les otorgó mayor autonomía',
      'Fueron suspendidos en su actividad',
      'Se fusionaron en un partido único',
      'No sufrieron cambios',
    ],
    correctIndex: 1,
    explanation: 'La Junta Militar suspendió la actividad de todos los partidos políticos como parte del "Proceso de Reorganización Nacional".',
    accent: 'jade',
  },
  {
    id: 10,
    type: 'flashcard',
    question: '¿Qué organizaciones armadas de izquierda operaban en Argentina en los años previos al golpe de 1976?',
    answer: 'Montoneros y el ERP (Ejército Revolucionario del Pueblo), entre otras.',
    explanation: 'Su accionar armado fue usado por la dictadura para justificar la represión ilegal y masiva, aunque esta alcanzó a un universo mucho más amplio que el de sus militantes.',
    accent: 'ruby',
  },
  {
    id: 11,
    type: 'truefalse',
    question: 'El golpe de 1976 contó con apoyo de sectores civiles, económicos y mediáticos, además de las Fuerzas Armadas.',
    options: ['Verdadero', 'Falso'],
    correctIndex: 0,
    explanation: 'Verdadero. Diversos sectores empresariales, mediáticos y políticos civiles respaldaron o acompañaron inicialmente al golpe.',
    accent: 'gold',
  },
];
