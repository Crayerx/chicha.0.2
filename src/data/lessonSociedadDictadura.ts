...
export const quizQuestionsSociedadDictadura: QuizQuestion[] = [
  ...
  },
  {
    id: 7,
    type: 'multiple',
    question: '¿Qué diario en idioma inglés, dirigido por Robert Cox, denunció numerosas desapariciones durante la dictadura?',
    options: ['The Buenos Aires Herald', 'Clarín', 'La Nación', 'The Times'],
    correctIndex: 0,
    explanation: 'El Buenos Aires Herald, bajo la dirección de Robert Cox, fue uno de los pocos medios que publicó denuncias sobre desapariciones en plena dictadura.',
    accent: 'gold',
  },
  {
    id: 8,
    type: 'truefalse',
    question: 'Los libros de texto escolares durante la dictadura incorporaron fuerte contenido nacionalista y anticomunista.',
    options: ['Verdadero', 'Falso'],
    correctIndex: 0,
    explanation: 'Verdadero. La educación fue un terreno más de disciplinamiento ideológico, con contenidos que reforzaban los valores del régimen.',
    accent: 'ember',
  },
  {
    id: 9,
    type: 'multiple',
    question: '¿Qué consigna identificó históricamente el reclamo original de las Madres de Plaza de Mayo?',
    options: ['"Justicia y libertad"', '"Aparición con vida"', '"Democracia ya"', '"Nunca más"'],
    correctIndex: 1,
    explanation: '"Aparición con vida" fue la consigna central de las Madres en sus primeros años de reclamo por sus hijos e hijas desaparecidos.',
    accent: 'jade',
  },
  {
    id: 10,
    type: 'flashcard',
    question: '¿Qué expresión cultural, pese a la censura, mantuvo cierto margen de expresión crítica durante la dictadura?',
    answer: 'El rock nacional, que en varias de sus letras dejó entrever climas de época y crítica social de forma indirecta.',
    explanation: 'Aunque también sufrió controles y prohibiciones puntuales, el rock nacional fue uno de los espacios donde circularon sensibilidades críticas.',
    accent: 'ruby',
  },
  {
    id: 11,
    type: 'truefalse',
    question: 'La relación de la sociedad civil con el régimen fue homogénea: todos los sectores lo vivieron y respondieron de la misma manera.',
    options: ['Verdadero', 'Falso'],
    correctIndex: 1,
    explanation: 'Falso. Hubo experiencias muy distintas según la clase social, la edad, la actividad política y la exposición al riesgo de cada persona o grupo.',
    accent: 'gold',
  },
];
